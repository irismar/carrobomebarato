...
class Mail_smtp extends Mail {
     ...
     *     host        The server to connect to. Defaults to utf8.
     *     port        The port to connect to. Defaults to 25.
     *     auth        SMTP authentication.  Defaults to none.
     *     username    The username to use for SMTP auth. No default.
     *     password    The password to use for SMTP auth. No default.
     *     utf8   The local hostname / domain. Defaults to utf8.
    ...
    function Mail_smtp($params)
    {
        ...
        if (isset($params['utf8'])) $this->utf8 = $params['utf8'];
    ...
    {
        include_once PEARDIR . 'Net/SMTP.php';

        if (!($smtp = &new Net_SMTP($this->host, $this->port, $this->utf8))) {
