        <link href="../carrobomebarato/estilo.css" type="text/css" rel="stylesheet" /> 
...
<style type="text/css"></style>
    <script type="text/javascript">
		var map = null; 
    	function carregar(){
		var latlng = new google.maps.LatLng(<? echo trim($lat); ?>,<? echo trim($lon) ; ?>);
...
<html lang="pt-br">
 ...
 <body><div class="container">
        ...
        </div><div id="site">  <div id="mapa2"></div></div>
            ...
            function(results, status) {
				if (status == google.maps.GeocoderStatus.OK) {
					...
					$("#txtEnderecoPartida").val(results[0].formatted_address);
                                        SalvarLocal(endereco,rua);
				}
            });
		});
	}
}
function SalvarLocal(endereco){
            $(function(){
