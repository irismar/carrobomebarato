...
while($row = $query->fetch_assoc()) { 
 ...
 </style><link rel="stylesheet" type="text/css" href="/css/estilo.css?<?=time();?>" />
 </style>
...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/css/estilo.css?<?=time();?>">
    </head>
 <style type="text/css">
    ...
    <div class="col-md-6">    <legend>Criar rotas </legend>
          ...
          <p>Habilite o Compartilhamento de Localização <br> </p>
          <img src="/img/localiza.png" class="">
            </h1>;
         </ul></div>
                </fieldset>
            </form>
