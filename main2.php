 ...
 <div id="caixa_redesocial8">
  ...
  <img src="/galeriadefotos/novo/<?php if (($row_estoque['foto_membro'] <> '') and ((file_exists("galeriadefotos/peq/".$row_estoque['foto_membro'])))) { echo $row_estoque['foto_membro']; } else { echo "avatar.jpg"; } ?>" alt="...">
     ...
     <br />                                                                                                                                                                                                                                     
       ...
       <p class="navbar-text-left"><span class="glyphicon glyphicon-user img-circle img-responsive img-center" aria-hidden="true">
  ...
  <span class="glyphicon glyphicon-map-marker" aria-hidden="true">  <a href="#" class="navbar-link">   <? echo @$distancia= distancia( $row_estoque['lat'], $row_estoque['lon'],$_SESSION['lat'], $_SESSION['log']) ?> 
		...
		<p class="navbar-text-left"><span class=" glyphicon glyphicon-map-marker " aria-hidden="true">
        ...
        <p class="navbar-text-left"><span class="glyphicon glyphicon-list-alt" aria-hidden="true">
 ...
 <?php
  ...
  $query2 = $mysql->query($sql2);
	...
	<?php if ( $query_vicitas['foto_carro']!='') { ?>
           ...
           <div id="caixa_respostas"><h1><samp class="fa fa-taxi fa-1x"></samp><?php echo  $query_vicitas['marca'].'&nbsp;'.$query_vicitas['modelo']; ?></a> </h1>

        <h1><samp class="glyphicon glyphicon-map-marker"></samp><?php echo  $query_vicitas['endereco']; ?></a> </h1>
          <h1><samp class="fa fa-calendar-o fa-1x "></samp><?php echo data22( $query_vicitas['data']); ?></a> </h1>      
 ...
 <div id="ver_descricao_estoque">
  ...
  <div id="ver_descricao_foto2"><a href="#"><strong class="azul_resposta"><?php echo  @$query_cont['mensagem']; ?></strong></a></div>
   ...
   <div id="caixa_respostas">             
    ...
    <p> <a href=" "> &nbsp;<?php echo @data22( $query_cont['data']); ?> </a> </p>
...
<img src="/galeriadefotos/peq/<?php echo @$_SESSION['foto'];?>" width="40" height="50" class="caixa_estoque80"> 
 ...
 /////////////////se estiver logado nas são for for dono do anuncio//fim/////
     ...
     <input type="hidden"  placeholder="Seu nome" name="nome" required  id="nome" />

     <input  type="hidden" name="email"placeholder="Telefone" required   name="email" id="email" />
