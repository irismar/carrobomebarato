 ...
 $row_estoque["modelotexto"]; $modelo1 = explode(" ",$row_estoque["modelotexto"]);
   $modelo1[0]; 
 echo  $sql_opcionais = "SELECT A.acessorios FROM acessorios_carros AS AC 
...
echo $totalRows_opcionais = $query->num_rows;  
...
<? }  else{ ?>    
  ...
  <? if(file_exists("images/".$row_estoque['marcatexto'].".png")){ ?>
   <a href="/<? echo trim( $row_estoque['marcatexto']); ?>"> <img src="/marcas/<? if (($row_estoque['marcatexto'].".png"<> '') and ((file_exists("images/".$row_estoque['marcatexto'].".png")))) { echo $row_estoque['marcatexto'].".png"; } else { echo $row_estoque['marcatexto']; } ?>"></a>
